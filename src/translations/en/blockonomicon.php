...
return [
	...
	'The <strong>storage</strong> folder for Blockonomicon could not be found, so a new one has been created at <code>{path}</code>. This is the folder that contains base templates used to generate HTML, CSS, and JS for newly created blocks. If you are migrating Craft installations and have overlooked the <strong>storage</strong> folder, it can be copied to this location now.' => 'The <strong>storage</strong> folder for Blockonomicon could not be found, so a new one has been created at <code>{path}</code>. This is the folder that contains base templates used to generate HTML, CSS, and JS for newly created blocks. If you are migrating Craft installations and have overlooked the <strong>storage</strong> folder, it can be copied to this location now.',
	'The <strong>block</strong> folder for Blockonomicon could not be found, so a new one has been created at <code>{path}</code>. This is the folder that contains the HTML, CSS, JS, and field configuration JSON for each block. If you are migrating Craft installations and have overlooked the <strong>block</strong> folder, it can be copied to this location now.' => 'The <strong>block</strong> folder for Blockonomicon could not be found, so a new one has been created at <code>{path}</code>. This is the folder that contains the HTML, CSS, JS, and field configuration JSON for each block. If you are migrating Craft installations and have overlooked the <strong>block</strong> folder, it can be copied to this location now.',
];
